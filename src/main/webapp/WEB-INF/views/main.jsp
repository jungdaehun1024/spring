...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/css/pluton.css" />
        <!--[if IE 7]>
            <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/css/pluton-ie7.css" />
        <![endif]-->
        <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/css/jquery.cslider.css" />
        ...
        <!-- Fav and touch icons -->
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<%=request.getContextPath()%>/resources/images/ico/apple-touch-icon-144.png">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<%=request.getContextPath()%>/resources/images/ico/apple-touch-icon-114.png">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<%=request.getContextPath()%>/resources/images/apple-touch-icon-72.png">
        <link rel="apple-touch-icon-precomposed" href="<%=request.getContextPath()%>/resources/images/ico/apple-touch-icon-57.png">
    ...
    <body>
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container">
                    <a href="#" class="brand">
                        <img src="<%=request.getContextPath()%>/resources/images/logo.png" width="120" height="40" alt="Logo" />
            ...
            <div id="da-slider" class="da-slider">
                ...
                <div class="container">
                    ...
                    <div class="da-slide">
                        ...
                        <div class="da-img">
                            <img src="<%=request.getContextPath()%>/resources/images/Slider01.png" alt="image01" width="320">
                        </div>
                    </div>
                    <!-- End first slide -->
                    <!-- Start second slide -->
                    <div class="da-slide">
                        ...
                        <a href="#" class="da-link button">Read more</a>
                        <div class="da-img">
                            <img src="<%=request.getContextPath()%>/resources/images/Slider02.png" width="320" alt="image02">
                        </div>
                    </div>
                    <!-- End second slide -->
                    <!-- Start third slide -->
                    <div class="da-slide">
                        ...
                        <a href="#" class="da-link button">Read more</a>
                        <div class="da-img">
                            <img src="<%=request.getContextPath()%>/resources/images/Slider03.png" width="320" alt="image03">
                        </div>
                    </div>
                    <!-- Start third slide -->
            ...
            <div class="container">
                ...
                <div class="row-fluid">
                    <div class="span4">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <img class="img-circle" src="<%=request.getContextPath()%>/resources/images/Service1.png" alt="service 1">
                            </div>
                            <h3>Modern Design</h3>
                    ...
                    <div class="span4">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <img class="img-circle" src="<%=request.getContextPath()%>/resources/images/Service2.png" alt="service 2" />
                            </div>
                    ...
                    <div class="span4">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <img class="img-circle" src="<%=request.getContextPath()%>/resources/images/Service3.png" alt="service 3">
                            </div>
                            <h3>Clean Code</h3>
            ...
            <div class="container">
                ...
                <div id="single-project">
                    <div id="slidingDiv" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<%=request.getContextPath()%>/resources/images/Portfolio01.png" alt="project 1" />
                        </div>
                        <div class="span6">
                    ...
                    <div id="slidingDiv1" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<%=request.getContextPath()%>/resources/images/Portfolio02.png" alt="project 2">
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv2" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<%=request.getContextPath()%>/resources/images/Portfolio03.png" alt="project 3">
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv3" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<%=request.getContextPath()%>/resources/images/Portfolio04.png" alt="project 4">
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv4" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<%=request.getContextPath()%>/resources/images/Portfolio05.png" alt="project 5">
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv5" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<%=request.getContextPath()%>/resources/images/Portfolio06.png" alt="project 6">
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv6" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<%=request.getContextPath()%>/resources/images/Portfolio07.png" alt="project 7">
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv7" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<%=request.getContextPath()%>/resources/images/Portfolio08.png" alt="project 8">
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv8" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="<%=request.getContextPath()%>/resources/images/Portfolio09.png" alt="project 9">
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
            ...
            <div class="container">
                ...
                <div class="row-fluid team">
                    <div class="span4" id="first-person">
                        <div class="thumbnail">
                            <img src="<%=request.getContextPath()%>/resources/images/Team1.png" alt="team 1">
                            <h3>John Doe</h3>
                            <ul class="social">
                                <li>
                                    <a href="">
                    ...
                    <div class="span4" id="second-person">
                        <div class="thumbnail">
                            <img src="<%=request.getContextPath()%>/resources/images/Team2.png" alt="team 1">
                            <h3>John Doe</h3>
                            <ul class="social">
                                <li>
                                    <a href="">
                    ...
                    <div class="span4" id="third-person">
                        <div class="thumbnail">
                            <img src="<%=request.getContextPath()%>/resources/images/Team3.png" alt="team 1">
                            <h3>John Doe</h3>
                            <ul class="social">
                                <li>
                                    <a href="">
                    ...
                    <div class="row">
                        <div class="span4">
                            <div class="testimonial">
                                ...
                                <div class="whopic">
                                    <div class="arrow"></div>
                                    <img src="<%=request.getContextPath()%>/resources/images/Client1.png" class="centered" alt="client 1">
                                    <strong>John Doe
                                        <small>Client</small>
                                    </strong>
                                </div>
                        ...
                        <div class="span4">
                            <div class="testimonial">
                                ...
                                <div class="whopic">
                                    <div class="arrow"></div>
                                    <img src="<%=request.getContextPath()%>/resources/images/Client2.png" class="centered" alt="client 2">
                                    <strong>John Doe
                                        <small>Client</small>
                                    </strong>
                                </div>
                        ...
                        <div class="span4">
                            <div class="testimonial">
                                ...
                                <div class="whopic">
                                    <div class="arrow"></div>
                                    <img src="<%=request.getContextPath()%>/resources/images/Client3.png" class="centered" alt="client 3">
                                    <strong>John Doe
                                        <small>Client</small>
                                    </strong>
                                </div>
            ...
            <div class="container centered">
                <div class="sub-section">
                    ...
                    <ul class="row client-slider" id="clint-slider">
                        <li>
                            <a href="">
                                <img src="<%=request.getContextPath()%>/resources/images/clients/ClientLogo01.png" alt="client logo 1">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<%=request.getContextPath()%>/resources/images/clients/ClientLogo02.png" alt="client logo 2">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<%=request.getContextPath()%>/resources/images/clients/ClientLogo03.png" alt="client logo 3">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<%=request.getContextPath()%>/resources/images/clients/ClientLogo04.png" alt="client logo 4">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<%=request.getContextPath()%>/resources/images/clients/ClientLogo05.png" alt="client logo 5">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<%=request.getContextPath()%>/resources/images/clients/ClientLogo02.png" alt="client logo 6">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<%=request.getContextPath()%>/resources/images/clients/ClientLogo04.png" alt="client logo 7">
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="footer">
            <p>&copy; 2024 Theme by <a href="http://www.graphberry.com">GraphBerry</a>, <a href="http://goo.gl/NM84K2">Documentation</a></p>
        </div>
        <!-- Footer section end -->
        ...
        <script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/jquery.mixitup.js"></script>
        ...
        <script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/jquery.inview.js"></script>
